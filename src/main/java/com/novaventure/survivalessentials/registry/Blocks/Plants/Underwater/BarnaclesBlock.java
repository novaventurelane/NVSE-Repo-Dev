...
public class BarnaclesBlock extends FacingBlock implements Waterloggable {
    ...
    static {
        ...
        WEST_SHAPE = Block.createCuboidShape(16.0D, 0.0D, 0.0D, 15.0D, 16.0D, 16.0D);
